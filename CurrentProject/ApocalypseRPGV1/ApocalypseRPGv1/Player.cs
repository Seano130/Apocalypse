...
{
    public class Player : ILocateable, IProfession, ISpeakable
    {
        ...
        public Player(string nm, Animation ani, Vector pos, Vector vel, Dialogue dlg, int maxSpd)
        {
            Name = nm;
            this.ani = ani;
            Position = pos;
